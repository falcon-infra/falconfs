...
#define CONFIGURE_ARGS " '--prefix=/root/metadb'"
...
#define PG_VERSION_STR "PostgreSQL 15.1 on x86_64-pc-linux-gnu, compiled by gcc (Ubuntu 13.3.0-6ubuntu2~24.04) 13.3.0, 64-bit"
