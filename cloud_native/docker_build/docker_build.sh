...
export FALCONFS_INSTALL_DIR="${FALCONFS_INSTALL_DIR:-${HOME}/falconfs}"
FALCONFS_DIR="$(cd "${DIR}/../../" >/dev/null 2>&1 && pwd)"
...
cp -rf "${FALCONFS_INSTALL_DIR}" "${FALCONFS_DIR}/cloud_native/docker_build"
